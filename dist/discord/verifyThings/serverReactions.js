export default async function reactionRoles(client, text) {
    ...
    const handleReaction = async (reaction, user, add) => {
        ...
        const role = await reaction.message.guild.roles.cache.find((r) => r.name == rolename);
...
export async function setUproles(client, id, text, reactions) {
...
export function addReactions(message, reactions) {
